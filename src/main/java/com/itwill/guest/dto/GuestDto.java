...
public class GuestDto {
	...
	public static GuestDto toDto(Guest guestEntity) {
		return GuestDto.builder()
					.guestNo(guestEntity.getGuestNo())
					.guestName(guestEntity.getGuestName())
					.guestDate(guestEntity.getGuestDate())
					.guestEmail(guestEntity.getGuestEmail())
					.guestHomepage(guestEntity.getGuestHomepage())
					.guestTitle(guestEntity.getGuestTitle())
					.guestContent(guestEntity.getGuestContent())
					.build();
	}
